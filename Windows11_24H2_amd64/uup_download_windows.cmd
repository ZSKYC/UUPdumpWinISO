@echo off
:: Generated on 2026-02-12 12:33:10 GMT
...
:START_PROCESS
title 26100.7840_amd64_zh-cn_professional_474c52a7 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=474c52a7-fe5f-4832-8ded-53ea7b70c2db&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
