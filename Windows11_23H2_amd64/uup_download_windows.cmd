@echo off
:: Generated on 2026-02-12 12:35:10 GMT
...
:START_PROCESS
title 22631.6649_amd64_zh-cn_professional_49d55cd3 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=49d55cd3-516b-4bda-9f4c-285fe2178b45&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
